      ...
      <div className="p-2.5 border-t border-[#e9ebed] space-y-1.5">
        {onOpenTemplates && (
          <button
            ...
            className="w-full py-2 px-3 bg-[#0972d3] hover:bg-[#0961b9] text-white rounded-md text-xs font-medium transition-colors flex items-center justify-center gap-1.5"
          >
